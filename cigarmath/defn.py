...
__copyright__ = 'Copyright (C) 2022-present, Dampier & DV Klopfenstein, PhD. All rights reserved'
...
#              ---   -----------------------------------------------------  ------ -----
NTS = [
    NTO._make(['M', 'alignment match (can be a sequence match or mismatch)', True,  True]),
    ...
    NTO._make(['H', 'hard clipping (clipped sequences NOT present in SEQ)',  False, False]),
    NTO._make(['P', 'padding (silent deletion from the padded reference)',   False, False]),
