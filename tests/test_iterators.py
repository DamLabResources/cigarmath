...
def test_liftover():
    ...
    lift_pos = list(cm.liftover(cigartups, *lift_ref_pos,
                    reference_start=ref_start, edge='right'))
    ...
    lift_pos = list(cm.liftover(cigartups, *lift_ref_pos,
                    reference_start=ref_start, edge='left'))
    ...
    lift_pos = list(cm.liftover(cigartups, *lift_ref_pos,
                    reference_start=ref_start, edge=None))
